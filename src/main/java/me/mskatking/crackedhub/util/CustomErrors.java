...
public class CustomErrors {
    ...
    public static final Component CONTACT_DEVELOPERS = Component.text("Please contact the ", NamedTextColor.RED).append(Component.text("development team", NamedTextColor.RED).decorate(TextDecoration.UNDERLINED).hoverEvent(HoverEvent.showText(Component.text("MSKatKing", NamedTextColor.GRAY).appendNewline().append(Component.text("Puerry44", NamedTextColor.GRAY))))).append(Component.text(" ASAP!"));
}
